          ...
          <div className="text-center">
            <div className="w-full sm:inline-flex flex-col sm:flex-row items-center gap-4 sm:gap-6 bg-white rounded-2xl p-5 sm:p-8 shadow-xl border border-gray-100">
              <div className="text-center sm:text-left mb-4 sm:mb-0">
                <h3 className="text-lg sm:text-xl font-bold text-brand-ink mb-2">Ready to see similar results?</h3>
                <p className="text-sm sm:text-base text-gray-600">Get your free building inspection and discover potential savings.</p>
              </div>
              <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                <Link
                  href="/case-studies"
                  className="btn-secondary inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3 text-sm sm:text-base font-semibold rounded-xl min-h-[44px] w-full sm:w-auto"
                >
                  <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                  <span className="whitespace-nowrap">View All Stories</span>
                </Link>
                <Link
                  href="/contact"
                  className="btn-primary inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3 text-sm sm:text-base font-semibold rounded-xl min-h-[44px] w-full sm:w-auto"
                >
                  <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
