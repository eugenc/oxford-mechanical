        ...
        <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-sm font-semibold bg-white/20 px-3 py-1 rounded-full">HIGH-RISE CONDOS</span>
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold mb-6">
              High-Rise Condo Plumbing Services
            </h1>
            <p className="text-xl lg:text-2xl text-white/90 mb-8">
              Minimal disruption maintenance for high-density residential properties across the GTA.
            </p>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-display font-bold text-brand-ink mb-4">
            High-Rise Condo Solutions
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Specialized plumbing services for high-rise residential buildings.
          </p>
        </div>
      </section>
    </div>
