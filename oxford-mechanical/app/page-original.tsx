  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20 lg:pb-0">
      ...
      <div className="fixed bottom-6 right-6 z-40 hidden lg:block">
        <div className="floating-cta bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-200/50 p-6 max-w-sm hover:shadow-3xl transition-all duration-300 hover:scale-105">
